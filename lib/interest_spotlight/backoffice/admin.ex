defmodule InterestSpotlight.Backoffice.Admin do
  use Ecto.Schema
  ...
  defp validate_email(changeset, opts) do
    ...
    if Keyword.get(opts, :validate_unique, true) do
      changeset
      |> unsafe_validate_unique(:email, InterestSpotlight.Repo)
  ...
  """
  def valid_password?(
        %InterestSpotlight.Backoffice.Admin{hashed_password: hashed_password},
        password
      )
