defmodule InterestSpotlight.Backoffice do
  @moduledoc """
  ...
  alias InterestSpotlight.Backoffice.{Admin, AdminToken, AdminNotifier}
  ...
  See `InterestSpotlight.Backoffice.Admin.email_changeset/3` for a list of supported options.
  ...
  See `InterestSpotlight.Backoffice.Admin.password_changeset/3` for a list of supported options.
