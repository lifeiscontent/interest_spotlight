defmodule InterestSpotlightWeb.UserAuth do
  ...
  @remember_me_cookie "_interest_spotlight_web_user_remember_me"
  @remember_me_options [
    sign: true,
  ...
  def disconnect_sessions(tokens) do
    Enum.each(tokens, fn %{token: token} ->
      InterestSpotlightWeb.Endpoint.broadcast(user_session_topic(token), "disconnect", %{})
    end)
  end
  ...
  the `current_scope`:
      ...
      defmodule InterestSpotlightWeb.PageLive do
        ...
        on_mount {InterestSpotlightWeb.UserAuth, :mount_current_scope}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{InterestSpotlightWeb.UserAuth, :require_authenticated}] do
